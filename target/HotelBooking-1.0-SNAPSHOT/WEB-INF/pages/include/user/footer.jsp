        ...
        <div class="row mb-5">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <div class="block-21 d-flex mb-4">
                    <figure class="mr-3">
                        <img src="<c:url value="/resource/user/images/img_1.jpg"/>" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
                ...
                <div class="block-21 d-flex mb-4">
                    <figure class="mr-3">
                        <img src="<c:url value="/resource/user/images/img_2.jpg"/>" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
                        <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
                        <div class="meta">
                ...
                <div class="block-21 d-flex mb-4">
                    <figure class="mr-3">
                        <img src="<c:url value="/resource/user/images/img_3.jpg"/>" alt="" class="img-fluid">
                    </figure>
                    <div class="text">
                        <h3 class="heading"><a href="#">Our Luxury Hotel &amp; Restaurants</a></h3>
                        <div class="meta">
